...
for dealing with unexpected user inputs. // FALSE
...
to ensure that the program runs even if something unexpected happens. // FALSE
...
that the VM uses to exit the program when something unexpected happens. // FALSE
